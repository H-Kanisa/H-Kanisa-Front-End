...
class PopupNotifier extends ChangeNotifier {
  ...
  setSelectedDish({ String value}) {
    selectedDish = value;
    notifyListeners();
  }

  bool isFoodFiltered = false;
  toggleFoodFilter({ bool value}) {
...
class FlutterSwiggyButtonWidget extends StatelessWidget {
  const FlutterSwiggyButtonWidget();      

  @override
  Widget build(BuildContext context) {
    PopupNotifier popupNotifier({ bool renderUI}) =>
    ...
    pButton({ String title,  double price}) {
          ...
          return Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                  color: AppColor.scaffoldColor, borderRadius: BorderRadius.circular(25)),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
